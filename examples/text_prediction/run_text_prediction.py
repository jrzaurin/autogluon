...
def get_parser():
    parser = argparse.ArgumentParser(
        description="The Basic Example of AutoML for Text Prediction."
    )
    parser.add_argument(
        "--train_file", type=str, help="The training pandas dataframe.", default=None
    )
    parser.add_argument(
        "--dev_file", type=str, help="The validation pandas dataframe", default=None
    )
    parser.add_argument(
        "--test_file", type=str, help="The test pandas dataframe", default=None
    )
    parser.add_argument("--seed", type=int, help="The seed", default=None)
    ...
    parser.add_argument(
        "--stop_metric", type=str, help="The metrics for early stopping", default=None
    )
