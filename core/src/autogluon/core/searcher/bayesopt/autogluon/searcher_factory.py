...
from .gp_multifidelity_searcher import (
...
from ..models.gpmodel_skipopt import (
...
def _create_common_objects(**kwargs):
    ...
    if kwargs.get("opt_debug_writer", False):
        ...
        debug_writer = DebugGPRegression(fname_msk=fname_msk, rolling_size=5)
...
def gp_multifidelity_searcher_factory(**kwargs) -> GPMultiFidelitySearcher:
    ...
    if _resource_acq == "bohb":
        ...
        assert _resource_acq == "first", "resource_acq must be 'bohb' or 'first'"
